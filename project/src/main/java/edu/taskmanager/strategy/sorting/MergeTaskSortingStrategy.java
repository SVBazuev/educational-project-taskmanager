...
public class MergeTaskSortingStrategy {
     ...
     */
    private static List<Task> mergeSortRecursive(List<Task> tasks, Comparator<Task> comparator, int left, int right) {
        if (left < right) {
     ...
     */
    private static void merge(List<Task> tasks, Comparator<Task> comparator, int left, int middle, int right) {
